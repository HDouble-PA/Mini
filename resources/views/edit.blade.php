...
<div class="card mt-4">
    ...
    <div class="card-body px-lg-5 pt-0">
        ...
        <form class="text-center" style="color: #757575;" action="{{route("update",$pizza->id)}}" method="post">
            ...
            <div class="md-form mt-4">
                <input type="text" id="materialRegisterFormEmail" class="form-control" name="toppings" value="{{$pizza->toppings}}">
            ...
            <!-- Sign up button -->
            <button class="btn green btn-rounded btn-block my-4 waves-effect z-depth-0" type="submit" >Update</button>
